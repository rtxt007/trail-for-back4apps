...
gesture_dict = {
    ...
    'Zooming In With Full Hand': 9, 9: 'Zooming In With Full Hand',
    'Zooming Out With Full Hand': 10, 10: 'Zooming Out With Full Hand',
    'Pushing Hand Away': 11, 11: 'Pushing Hand Away',
    'Shaking Hand': 12,12: 'Shaking Hand',
    'Thumbs Down': 13, 13: 'Thumbs Down',
    'Thumbs Up': 14, 14: 'Thumbs Up',
...
parser.add_argument("-cp", "--checkpoint", default="./checkpoint.pth.tar", help="Location of model checkpoint file")
